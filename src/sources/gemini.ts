...
1. This page MUST be the community's own page — its homepage, landing page, about page, or platform profile. If this is a blog post, listicle, directory, news article, comparison article, promotional page, or any page hosted on a DIFFERENT domain than the community itself, return {"valid": false, "reason": "third-party page about a community"}. Example: a blog post on thedesignerstoolbox.com describing a Slack community is NOT the community's own page.
...
6. The primaryUrl MUST be a direct link to the community itself — a platform URL (discord.gg/*, join.slack.com/*, reddit.com/r/*, skool.com/*, circle.so/*, etc.) or the community's own domain. NEVER return a URL to a podcast, blog, social media profile, Instagram, or unrelated website.
